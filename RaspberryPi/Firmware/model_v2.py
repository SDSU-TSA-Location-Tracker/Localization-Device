...
Xnew, Ynew = oversamp.fit_resample(X, Y)

X = Xnew

encoder = preprocessing.LabelEncoder()
encoder.fit(Y)
Y = encoder.transform(Ynew)
...
data = pd.read_csv("newdata_big.csv", engine = 'python')
data = data.sample(frac=1)
